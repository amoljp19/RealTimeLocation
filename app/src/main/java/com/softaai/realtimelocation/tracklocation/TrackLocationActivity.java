package com.softaai.realtimelocation.tracklocation;
...
import com.softaai.realtimelocation.App;
import com.softaai.realtimelocation.R;
import com.softaai.realtimelocation.ViewModelFactory;
import com.softaai.realtimelocation.data.rxfirestore.errors.DocumentNotExistsException;
    ...
    private void locationUpdated(SharedLocation sharedLocation) {
        ...
        if (mGoogleMap != null && mMyLocMarker == null) {
            MarkerOptions options = new MarkerOptions()
                    .title(sharedLocation.getUserId())
                    .position(pos);
